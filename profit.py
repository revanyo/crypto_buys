...
def save_profit_data():
    ...
    new_row = {
        ...
        "KAS New Average Buy Price": round(kaspa_new_average, 4),
        "KAS Total Average Buy Price": round(kaspa_total_average, 4),
        "BTC Total Average Buy Price": round(bitcoin_total_average, 2),
